...
const RULES: Array<{ kw: RegExp; category: string; subcategory?: string }> = [
  ...
  {
    kw: /\b(netflix|spotify|prime ?video|disney|hbo|youtube ?premium|chatgpt|openai|claude|github|figma|notion)\b/i,
    category: "Assinaturas",
    subcategory: "Streaming",
  },
  {
    kw: /\b(carrefour|extra|pão de açúcar|atacad|sams|assa[ií]|big|mercado|hortifruti|supermerc)\b/i,
    category: "Mercado",
  },
  {
    kw: /\b(restaurante|rest\b|bar |padaria|burger|pizza|sushi|cafe|coffee|starbucks)\b/i,
    category: "Restaurante",
  },
  {
    kw: /\b(drogaria|farmacia|farmácia|drogasil|raia|pacheco|pague menos)\b/i,
    category: "Farmácia",
  },
  ...
  {
    kw: /\b(amazon|magalu|magazine luiza|shopee|mercado ?livre|aliexpress|americanas)\b/i,
    category: "Compras",
  },
  ...
  {
    kw: /\b(salario|salário|sal\.|pagamento|pix recebido|transferencia recebida|transferência recebida|cred|crédito recebido)\b/i,
    category: "Trabalho",
  },
...
export function heuristicCategory(
  ...
  for (const r of RULES) {
    if (r.kw.test(desc))
      return { category: r.category, subcategory: r.subcategory, confidence: 0.6 };
  }
  return null;
}
